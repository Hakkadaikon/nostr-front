      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900/60">
        ...
        <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
          ...
          <li className="flex items-start gap-3">
            <Link2 size={16} className="mt-1 text-gray-400" />
            <div className="flex w-full items-center justify-between gap-2 rounded-lg bg-gray-100 px-3 py-2 font-mono text-xs text-gray-600 dark:bg-gray-800/70 dark:text-gray-300">
